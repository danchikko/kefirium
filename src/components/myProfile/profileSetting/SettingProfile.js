	...
	return (
		<Container>
			...
			<RightBlock>
                ...
                <Text size="16px" color="#000000" weight="700"> Баннер</Text>
                <Text size="17px" color="#8f9499">Рекомендуемые значения 1920х250 пикселей.</Text>
                <ImageBanner src='https://kefirium.ru/storage/app/uploads/public/627/e56/014/627e56014133e775303897.png' alt='bannerImage' />
			</RightBlock>
		</Container>
	)
}
