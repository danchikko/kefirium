...
import { artClick, musicClick, sortedPost, sportClick } from '../../store/optionsSlice'
...
const CategoriesPage = () => {
	...
	return (
		<Container>
			...
			<Link onClick={() => dispatch(sortedPost('art'), dispatch(artClick()))}
						to='/categories'>
				<Card>
			...
			<Link onClick={() => dispatch(sortedPost('sport'), dispatch(sportClick()))}
			to='/categories'>
			<Card>
			...
			<Link onClick={() => dispatch(sortedPost('music'), dispatch(musicClick))} to='/categories'>
			<Card>
