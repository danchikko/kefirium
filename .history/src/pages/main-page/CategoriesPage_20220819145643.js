...
const CategoriesPage = () => {
	...
	return (
		<Container>
			...
			<Link to="/categories" onClick={() => dispatch(sortedPost('photo'), dispatch(photoClick()))}>
			<Card>
			...
			<Link to="/categories" onClick={() => dispatch(sortedPost('collectibles'), dispatch(collectiblesClick()))}>
			<Card>
			...
			<Link to='/categories' onClick={() => dispatch(sortedPost('virtualworlds'), dispatch(virtualworldsClick()))}>
			<Card>
