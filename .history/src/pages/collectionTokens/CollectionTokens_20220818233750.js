...
const CollectionTokens = () => {
	...
	useEffect(() => {
		fetch('http://localhost:3000/NFTtokens')
		 ...
		 .then((data) => setTokens(data.slice(0,6)))
	}, [id])
	...
	return (
		<Container>
			...
			<HeadInfo>
				...
				<Text style={{margin: '5px 0 0 0'}} color='#8f9499' weight='700' size='15px'>
				...
				<Text style={{margin: '5px 0 0 0'}} color='#8f9499' size='15px' weight='700'>
