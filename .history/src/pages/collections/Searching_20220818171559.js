	...
	return (
		<Container>
			...
			<FlexSearch justify="space-between" width="200px">
                ...
                {filter ? <Filter>
                    {price ? <ActiveText>По цене</ActiveText> : <NotActiveText onClick={priceChangeHandler}>По цене</NotActiveText>}
                    {createDate ? <ActiveText>По дате создания</ActiveText> : <NotActiveText onClick={createDateChangeHandler}>По дате создания</NotActiveText>}
