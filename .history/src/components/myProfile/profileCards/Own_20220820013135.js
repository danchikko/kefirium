									...
									<Card>
										...
										<InfoBlock>
											...
											<AuthorBlock>
												...
												>
													<img
														src='https://kefirium.ru/storage/app/uploads/public/627/f7d/ba6/627f7dba656ce670948783.jpg'
														alt='authorImage'
													/>
													<div>
														<Text style={{margin: '0 7px'}} color='#8f9499'>
															Автор
														</Text>
                                                        <Text style={{margin: '5px'}} color="#8f9499">{token.nickname}</Text>
													</div>
												</div>
											</AuthorBlock>
										</InfoBlock>
