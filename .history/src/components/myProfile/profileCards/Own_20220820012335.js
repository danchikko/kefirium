							...
							return (
								...
								>
									<Card>
										...
										/>
										<InfoBlock>
											<Text style={{margin: 0}} color='#959595' weight='700' size="16px">
												{token.NFTName}
											</Text>
                                            <Text style={{margin: '6px 0'}}>{token.description}</Text>
                                            <PriceLike>
                                                <Text color="#e7246a" weight="700">{token.price} ₽</Text>
                                                <div style={{display: 'flex', alignItems: 'center', gap: '10px', margin: 0}}>
                                                    <BsHeart style={{margin: 0 , color: '#959595'}} /> <Text color="#959595">2</Text>
                                                </div>
                                            </PriceLike>
                                            <AuthorBlock>
                                                <div>
                                                    <img src='https://kefirium.ru/storage/app/uploads/public/627/f7d/ba6/627f7dba656ce670948783.jpg' alt='authorImage' />
                                                </div>
                                            </AuthorBlock>
										</InfoBlock>
									</Card>
...
const AuthorBlock = styled.div`
    display: flex;
    justify-content: space-between;
    border-top: 1.5px dashed #8f9499;
    align-items: center;
    & img {
        width: 36px;
        height: 36px;
