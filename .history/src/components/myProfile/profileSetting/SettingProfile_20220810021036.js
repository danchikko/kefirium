	...
	return (
		<Container>
			<LeftBlock>
				...
				<TextFlex>
					<Check />
					<Text size='16px' color='#8f9499'>
						Чтобы ускорить проверку данных вашего профиля (для
						получения отметки Проверенный автор) сделайте публикацию
						в своей соц сети с хэштегом #NICKNAME_LOVE_KEFIR
					</Text>
				</TextFlex>
			</LeftBlock>
		</Container>
