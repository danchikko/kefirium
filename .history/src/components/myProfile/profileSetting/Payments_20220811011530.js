...
const Payments = () => {
    const data = [
        {id: 1, date: '6 дней', number: 190, description: 'Оплата нтф токена', sum: '1100 ₽'},
        {id: 2, date: '6 дней', number: 190, description: 'Оплата нтф токена', sum: '1100 ₽'},
        {id: 3, date: '6 дней', number: 190, description: 'Оплата нтф токена', sum: '1100 ₽'},
    ]
	return (
		<Container>
			...
			<Table cellSpacing="0">
				<Thead>
					<Tr>
						<DateTh>Дата</DateTh>
						<NumberTh>№</NumberTh>
						<DescriptioTh>Описание</DescriptioTh>
						<SumTh>Сумма</SumTh>
					</Tr>
				</Thead>
				<TBody>
