...
import { safetyProfile, withdrawalsProfile } from '../../../store/profileSlice'
	...
	return (
		<Container>
			...
			{safety ? (
				...
				<Links onClick={() => dispatch(safetyProfile())} to='profile/settings/security'>Безопасность</Links>
			)}
			{withdrawals ? (
				...
				<Links onClick={() => dispatch(withdrawalsProfile())} to='profile/settings/payments'>Вывод средств</Links>
			)}
		</Container>
	)
}
