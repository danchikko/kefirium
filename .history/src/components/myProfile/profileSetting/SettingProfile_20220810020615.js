	...
	return (
		<Container>
			<LeftBlock>
                ...
                <Text>
                    <Check />Чтобы ускорить проверку данных вашего профиля (для получения отметки Проверенный автор) сделайте публикацию в своей соц сети с хэштегом #NICKNAME_LOVE_KEFIR
