	...
	return (
		<Container>
			...
			{safety ? (
				...
				<Links to='profile/settings/security'>Безопасность</Links>
			)}
            {withdrawals ? <ActiveLinks to='profile/settings/payments'>Вывод средств</ActiveLinks> : <Links to='profile/settings/payments'>Вывод средств</Links>}
		</Container>
	)
}
