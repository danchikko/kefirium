...
const Navbar = () => {
	...
	return (
		<Container>
			...
			{favoritesNFT ? <ActiveLinks to="/profile/favorites/favoritesNFT">Избранные NFT токены</ActiveLinks>: <Links to="/profile/favorites/favorites" onClick={() => dispatch(isValidFavoritesNFT())}>Избранные NFT токены</Links>}
		</Container>
	)
}
