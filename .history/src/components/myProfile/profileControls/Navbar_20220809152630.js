...
import { isValidFavoritesNFT, isValidMyCollections, isValidMyTokens, isValidOwn } from '../../../store/profileSlice'
...
const Navbar = () => {
	...
	return (
		<Container>
			...
			{favoritesNFT ? <ActiveLinks to="/profile/favorites/favoritesNFT">Избранные NFT токены</ActiveLinks>: <Links to="/profile/favorites/favoritesNFT" onClick={() => dispatch(isValidFavoritesNFT())}>Избранные NFT токены</Links>}
		</Container>
	)
}
