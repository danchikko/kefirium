...
const Navbar = () => {
	...
	return (
		<Container>
			...
			{favoritesNFT ? <ActiveLinks to="/profile/favorites/favoritesNFT">Избранные NFT токены</ActiveLinks>: <Links onClick={() => dispatch(isValidFavoritesNFT())}>Избранные NFT токены</Links>}
		</Container>
	)
}
