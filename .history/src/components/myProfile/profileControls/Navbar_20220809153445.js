...
const Navbar = () => {
	...
	return (
		<Container>
			...
			{favoritesCollection ? <ActiveLinks to="/profile/favorites/favoritesCollection">Избранные Коллекции</ActiveLinks>: <Links to="/profile/favorites/favorites">Избранные Коллекции</Links>}
		</Container>
	)
}
