...
const Navbar = () => {
	...
	return (
		<Container>
			...
			{favoritesCollection ? <ActiveLinks to="/profile/favorites/favoritesCollection">Избранные Коллекции</ActiveLinks>: <Links onClick={() => dispatch(isValid)} to="/profile/favorites/favoritesCollection">Избранные Коллекции</Links>}
		</Container>
	)
}
