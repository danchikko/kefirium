	...
	return (
		<div>
			...
			{modal ? (
				...
				>
					<Links
						onClick={() => dispatch(sortedPost('all'), )}
						to='/categories'
					>
						Все
					</Links>
					<Links
						onClick={() => dispatch(sortedPost('art'))}
						to='/categories'
					>
						Искусство
					</Links>
					<Links
						onClick={() => dispatch(sortedPost('sport'))}
						to='/categories'
					>
						Спорт
					</Links>
					<Links
						onClick={() => dispatch(sortedPost('music'))}
						to='/categories'
					>
						Музыка
					</Links>
					<Links
						onClick={() => dispatch(sortedPost('photo'))}
						to='/categories'
					>
						Фотография
					</Links>
					<Links
						onClick={() => dispatch(sortedPost('collectibles'))}
						to='/categories'
					>
