...
import { modalRegister, modalSignIn, modalSignUp, onRegister } from '../../store/registerSlice'
...
const Form = () => {
	...
	const handleSubmit = async (e) => {
		...
		try{
			...
			dispatch(modalRegister(), dispatch(onRegister(true)))
		}catch(e) {
			setError(e.message)
