				...
				<ListBlock>
					<FirstList>
						...
						<Links
							onClick={() =>
								dispatch(
									sortedPost('collectibles'),
									dispatch(collectiblesClick()),
								)
							}
							to='/categories'
						>
						...
						<Links
							onClick={() =>
								dispatch(
									sortedPost('virtualworlds'),
									dispatch(virtualworldsClick()),
								)
							}
							to='/categories'
						>
					...
					<SecondList>
						<Links to='/profile'>Мой профиль</Links>
						<Links to='/createCollection'>Создать коллекцию</Links>
					</SecondList>
				</ListBlock>
			</Blocks>
			<Info>
