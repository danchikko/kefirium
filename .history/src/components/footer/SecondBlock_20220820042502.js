...
const SecondBlock = () => {
	return (
		<Container>
			<Blocks>
				...
				<ListBlock>
					<FirstList>
						...
						<Links onClick={() => dispatch(sortedPost('all'), dispatch(allClick()))}
						to='/categories'>Все</Links>
						<Links to='/'>Искусство</Links>
						<Links to='/'>Спорт</Links>
						<Links to='/'>Музыка</Links>
						<Links to='/'>Фотография</Links>
						<Links to='/'>Коллекционные предметы</Links>
			...
			<Info>
				<Title size="14px" weight="500" margin="4px 0 0 0">ООО «Талимейн» (ИНН 7842113520)</Title>
				<Title size="14px" weight="500" margin="4px 0 0 0">
					191123, Санкт-Петербург, ул. Радищева, д. 39 литера в, офис
					28
				</Title>
				<Title size="14px" weight="500" margin="4px 0 0 0">Служба поддержки info@kefirium.ru</Title>
			</Info>
		</Container>
	)
}
