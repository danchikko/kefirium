...
import { allClick, artClick, sortedPost, sportClick } from '../../store/optionsSlice'
			...
			<Blocks>
				...
				<ListBlock>
					<FirstList>
						...
						<Links onClick={() => dispatch(sortedPost('music'), dispatch(musicClick()))}
						to='/categories'>Музыка</Links>
