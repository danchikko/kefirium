...
const FormPhysic = () => {
	...
	return (
		<Form onSubmit={handleSubmit}>
			...
			<Inputs onChange={(e) => setLastName(e.target.value)} placeholder='Введите фамилию' type='text' />
			<Text color='#000000' weight='700'>
				Имя*
			</Text>
			<Inputs onChange={(e) => setName(e.target.value)} placeholder='Введите имя' type='text' />
			<Text color='#000000' weight='700'>
				Никнейм*
			</Text>
			<Inputs onChange={(e) => setNickname(e.target.value)} type='text' placeholder='Введите никнейм' />
			<Text color='#000000' weight='700'>
				Email*
			</Text>
